...
class digital_storefront_Button extends WP_Customize_Section {
	...
	public function json() {
		...
		if ( ! $this->button_url && $digital_storefront_theme->get( 'ThemeURI' ) ) {

			$button_url = $digital_storefront_theme->get( 'ThemeURI' );

		// Fall back to the `Author URI` defined in `style.css`.
		} elseif ( ! $this->button_url && $digital_storefront_theme->get( 'AuthorURI' ) ) {

			$button_url = $digital_storefront_theme->get( 'AuthorURI' );
		}

		$json['button_text'] = $this->button_text ? $this->button_text : $digital_storefront_theme->get( 'Name' );
